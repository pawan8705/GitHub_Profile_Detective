...
3. 📦 Total public repositories count
4. ⭐ Total starred repositories count
5. ⭐ Filter Starred Repositories only
6. 🔗 Direct View Profile button (opens main GitHub profile)
7. 📋 Copy GitHub profile URL with one click
8. 🌙 Dark / Light mode toggle
9. 🔍 Search repositories by name
